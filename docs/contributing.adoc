...
= Contributing — lucidscript
:revdate: 2026-MM-DD

== Audience

Developers working *on* `lucidscript`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/lucidscript.git
cd lucidscript
...
* Bugs in `lucidscript`: file at `hyperpolymath/lucidscript/issues`.
