...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/lucidscript/security/advisories/new)
...
- This repository (`hyperpolymath/lucidscript`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/lucidscript/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/lucidscript/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/lucidscript/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/lucidscript/discussions) |
